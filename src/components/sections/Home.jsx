        ...
        <div className="min-h-screen flex flex-col-reverse lg:flex-row items-center justify-center relative gap-12">
          <div className="z-10 px-4 w-full max-w-2xl text-center lg:text-left">
            ...
            <p className="text-gray-300 text-lg md:text-xl mb-6 max-w-lg ">
              I build intelligent systems combining AI, computer vision, and
              software engineering.
            </p>
            {/* FULL DESCRIPTION */}
            <p className="text-gray-400 text-base mb-8 max-w-lg ">
              Fourth-year engineering student focused on AI and software
              development. I enjoy creating real-world solutions using machine
              learning, deep learning, and full-stack technologies — turning
              ideas into functional, scalable systems.
            </p>
...
<div className="hidden lg:block relative px-4 animate-[slideInRight_0.8s_ease-out_forwards]">            {/* glow */}
            ...
            >
              <img
                src="/douaatech-portfolio/myimg.png"
                alt="Profile"
